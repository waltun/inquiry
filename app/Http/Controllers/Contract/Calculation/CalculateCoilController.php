...
{
    public function evaperator(Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $categories = Category::where('parent_id', 0)->get();
        return view('contracts.calculation.coil.evaperator', compact('part', 'product', 'categories', 'contract', 'part2'));
    }

    public function waterCold(Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $categories = Category::where('parent_id', 0)->get();
        return view('contracts.calculation.coil.cold-water', compact('part', 'product', 'categories', 'contract', 'part2'));
    }

    public function waterWarm(Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $categories = Category::where('parent_id', 0)->get();
        return view('contracts.calculation.coil.warm-water', compact('part', 'product', 'categories', 'contract', 'part2'));
    }

    public function condensor(Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $categories = Category::where('parent_id', 0)->get();
        return view('contracts.calculation.coil.condensor', compact('part', 'product', 'categories', 'contract', 'part2'));
    }

    public function fancoil(Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $categories = Category::where('parent_id', 0)->get();
        return view('contracts.calculation.coil.fancoil', compact('part', 'product', 'categories', 'contract', 'part2'));
    }

    public function storeEvaperator(Request $request, Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $request->validate([
        ...
        $coilInput->contract_id = $contract->id;
        $coilInput->save();
    ...
    public function storeFancoil(Request $request, Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $request->validate([
            'name' => 'required|string|max:255',
        ]);
    ...
    public function storeWaterCold(Request $request, Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $request->validate([
            'name' => 'required|string|max:255',
        ]);
    ...
    public function storeWaterWarm(Request $request, Contract $contract, Part $part, ContractProduct $product, Part $part2)
    {
        $request->validate([
            'name' => 'required|string|max:255',
        ]);
