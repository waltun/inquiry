<x-layout>
    ...
    <div class="flex items-center space-x-2 space-x-reverse whitespace-nowrap">
        ...
        <a href="{{ route('contracts.marketings.index', $contract->id) }}" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="breadcrumb-svg">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mr-2">
                <p class="breadcrumb-p">
                    مدیریت بازاریابی های {{ $contract->name }}
                </p>
            </div>
        </a>
        <div>
        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    ایجاد بازاریابی جدید {{ $contract->name }}
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('contracts.marketings.store', $contract->id) }}" class="mt-4">
        @csrf
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <a href="{{ route('contracts.marketings.index', $contract->id) }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
