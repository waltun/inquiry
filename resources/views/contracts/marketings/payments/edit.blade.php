<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('contracts.marketings.payments.update', $marketPayment->id) }}" class="mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4 flex justify-center">
                <p class="bg-indigo-500 rounded-lg px-6 py-2 text-white">
                    بازاریاب : {{ $marketPayment->marketing->marketer->name }}
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputPrice" name="price" class="input-text"
                       value="{{ old('price', $marketPayment->price) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputText" name="text" class="input-text"
                       value="{{ old('text', $marketPayment->text) }}"
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            <button type="submit" class="form-edit-btn" id="submit-button">
                بروزرسانی پرداخت بازاریابی
            </button>
            <a href="{{ route('contracts.marketings.payments.index', $marketPayment->id) }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
