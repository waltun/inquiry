<x-layout>
    <x-slot name="js">
        ...
        <script>
            function changeValue() {
                let tedadMadarLoole = document.getElementById("inputTedadMadarLoole").value;
                let soorakhPakhshKon = document.getElementById("inputTedadSoorakhPakhshKon");

                soorakhPakhshKon.value = tedadMadarLoole;
            }
        </script>
    </x-slot>
        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    محاسبه قیمت کویل اواپراتوری DX
                </p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('contracts.calculateEvaperatorCoil', $contract->id) }}">
        @csrf
        <div class="my-4">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tedad_madar_coil" id="inputTedadMadar" class="input-text bg-yellow-300">
                            ...
                            <option value="2"
                                {{ is_null($inputs) ? (old('tedad_madar_coil') == '2' ? 'selected' : '') : ($inputs['tedad_madar_coil'] == '2' ? 'selected' : (old('tedad_madar_coil') == '2' ? 'selected' : '')) }}>
                                2
                            </option>
                            <option value="3"
                                {{ is_null($inputs) ? (old('tedad_madar_coil') == '3' ? 'selected' : '') : ($inputs['tedad_madar_coil'] == '3' ? 'selected' : (old('tedad_madar_coil') == '3' ? 'selected' : '')) }}>
                                3
                            </option>
                            <option value="4"
                                {{ is_null($inputs) ? (old('tedad_madar_coil') == '4' ? 'selected' : '') : ($inputs['tedad_madar_coil'] == '4' ? 'selected' : (old('tedad_madar_coil') == '4' ? 'selected' : '')) }}>
                                4
                            </option>
                            <option value="6"
                                {{ is_null($inputs) ? (old('tedad_madar_coil') == '6' ? 'selected' : '') : ($inputs['tedad_madar_coil'] == '6' ? 'selected' : (old('tedad_madar_coil') == '6' ? 'selected' : '')) }}>
                                6
                            </option>
                            <option value="8"
                                {{ is_null($inputs) ? (old('tedad_madar_coil') == '8' ? 'selected' : '') : ($inputs['tedad_madar_coil'] == '8' ? 'selected' : (old('tedad_madar_coil') == '8' ? 'selected' : '')) }}>
                                8
                            </option>
                        </select>
                    </div>
    ...
    <div class="mt-4">
        @if(!is_null($values))
            <form method="POST" action="{{ route('contracts.calculateCoil.storeEvaperator',[$contract->id, $part->id, $product->id. $part2->id]) }}"
