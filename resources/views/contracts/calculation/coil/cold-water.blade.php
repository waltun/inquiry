<x-layout>
    ...
    <form method="POST" action="{{ route('contracts.calculateColdCoil', $contract->id) }}">
        @csrf
        <div class="my-4">
    ...
    <div class="mt-4">
        @if(!is_null($values))
            <form method="POST" action="{{ route('contracts.calculateCoil.storeWaterCold', [$contract->id, $part->id, $product->id, $part2->id]) }}"
