    ...
    <x-slot name="js">
        ...
        <script>
            function changeRoute(type, contract, part, product, part2) {
                ...
                if (type == 'calculate') {
                    form.action = '/contracts/' + contract + '/air-condition-electrical';
                    form.submit();
                }

                if (type == 'post') {
                    form.action = '/contracts/' + contract + '/electrical/' + part + '/' + product + '/' + part2 + '/post-air-condition';
                    form.submit();
                }
            }
        </script>
    ...
    <div class="mt-4">
        ...
        <form method="POST" action="" id="form">
            ...
            @if(!is_null($part_ids))
                ...
                <div class="mb-4">
                    <button type="button" class="form-submit-btn" onclick="changeRoute('post', {{ $contract->id }}, {{ $part->id }}, {{ $product->id }}, {{ $part2->id }})">
                        ذخیره
                    </button>
                </div>
            @endif
