        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <select name="cash_type" id="inputCashType" class="input-text">
                    ...
                    <option value="no_cash" {{ old('cash_type') == 'no_cash' ? 'selected' : '' }}>
                        غیر نقدی
                    </option>
                    <option value="clearing" {{ old('cash_type') == 'clearing' ? 'selected' : '' }}>
                        تهاتر
                    </option>
                    <option value="currency" {{ old('cash_type') == 'currency' ? 'selected' : '' }}>
                        ارزی
                    </option>
                </select>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="account_id" id="inputAccount" class="input-text">
                    ...
                    @endforeach
                    <option value="0" {{ old('account_id') == "0" ? 'selected' : '' }}>
                        سایر
                    </option>
                </select>
            </div>
