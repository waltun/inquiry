<x-layout>
    ...
    <div class="flex items-center space-x-2 space-x-reverse whitespace-nowrap">
        ...
        <a href="{{ route('main-factors.index', $contract->id) }}" class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p">
                    مدیریت فاکتور های قیمتی {{ $contract->name }}
                </p>
            </div>
        </a>
        <div>
    ...
    <form method="POST" action="{{ route('main-factors.update', [$contract->id, $main_factor->id]) }}" class="mt-4">
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputDate" name="date" class="input-text" value="{{ old('date', $date) }}" placeholder="برای انتخاب تاریخ کلیک کیند">
            </div>
            <div class="mb-4">
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            <button type="submit" class="form-edit-btn" id="submit-button">
                بروزرسانی فاکتور قیمتی
            </button>
            <a href="{{ route('main-factors.index', $contract->id) }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
