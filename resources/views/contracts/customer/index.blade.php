<x-layout>
    ...
    <div class="mt-4 space-y-4">
        <div class="grid grid-cols-4 gap-4">
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    نوع مشتری : {{ $contract->customer->type == 'real' ? 'حقیقی' : 'حقوقی' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    نام : {{ $contract->customer->name ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    شناسه ملی / شماره ملی : {{ $contract->customer->nation ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    شماره ثبت شرکت : {{ $contract->customer->registration_number ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    شماره موبایل : {{ $contract->customer->phone ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    شماره موبایل شبکه های اجتماعی : {{ $contract->customer->social_phone ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    شماره ثابت : {{ $contract->customer->telephone ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    ایمیل : {{ $contract->customer->email ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white">
                <p class="text-sm font-medium">
                    کد پستی : {{ $contract->customer->postal ?? '-' }}
                </p>
            </div>
            <div class="p-2 rounded-md border border-gray-300 bg-white col-span-3">
                <p class="text-sm font-medium">
                    آدرس : {{ $contract->customer->address }}
                </p>
            </div>
        </div>
    </div>
