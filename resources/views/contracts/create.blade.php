<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('contracts.store') }}" class="mt-4">
        @csrf
        ...
        <div class="card">
            ...
            <div class="mb-4">
                <label for="inputCustomer" class="form-label">انتخاب مشتری</label>
                <select name="customer_id" id="inputCustomer" class="input-text">
