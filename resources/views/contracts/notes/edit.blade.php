<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('notes.update', [$contract->id, $note->id]) }}" class="mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputTitle" name="title" class="input-text" value="{{ old('title', $note->title) }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="text" id="inputText" class="input-text h-32 resize-none">{{ old('text', $note->text) }}</textarea>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <a href="{{ route('notes.index', $contract->id) }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
