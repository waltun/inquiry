<x-layout>
        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    دستور ساخت قرارداد {{ $contract->name }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-4 space-y-4">
        <div class="grid grid-cols-4 gap-4">
            <a href="{{ route('contracts.recipe.revision', [$contract->id, 1]) }}" class="dashboard-cards group">
                <div class="flex items-center">
                    <div class="dashboard-card-icon bg-green-500 dark:bg-slate-800">
                        <p class="text-sm font-bold text-white group-hover:text-myBlue-100">
                            1
                        </p>
                    </div>
                    <div class="mr-4">
