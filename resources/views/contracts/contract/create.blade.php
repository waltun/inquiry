<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('contract-files.store', $contract->id) }}" class="mt-4 grid grid-cols-2 gap-4" enctype="multipart/form-data">
        @csrf
