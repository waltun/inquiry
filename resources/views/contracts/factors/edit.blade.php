<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('factors.update', [$contract->id, $factor->id]) }}" class="mt-4 grid grid-cols-2 gap-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <div class="flex rounded-md">
                    <input type="text" class="input-file" id="inputFile" name="file" value="{{ old('file', $factor->file) }}"
