<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('pictures.update', [$contract->id, $picture->id]) }}" class="mt-4 grid grid-cols-2 gap-4" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputTitle" name="title" class="input-text" value="{{ old('title', $picture->title) }}"
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="file" class="input-file" id="inputFile" name="file" value="{{ old('file', $picture->file) }}">
            </div>
