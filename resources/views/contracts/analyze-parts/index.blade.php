                                                                ...
                                                                foreach ($contractAmounts as $contractAmount) {
                                                                    if ($contractAmount->product->contract->recipe) {
                                                                        ...
                                                                        $contractAmountInfo[$contractAmount->product->contract_id] = [
                                                                            ...
                                                                            "shopper" => $contractAmount->shopper,
                                                                ...
                                                                <div class="p-2 rounded-lg border border-gray-400">
                                                                    <form method="POST"
                                                                        ...
                                                                        <div class="grid grid-cols-4 gap-4 mt-6">
                                                                            ...
                                                                            <div>
                                                                                <select name="shopper"
                                                                                        id="inputShopper{{ $part->id }}"
                                                                                        class="input-text {{ !is_null($contractAmountValue["shopper"]) ? 'bg-green-100' : '' }}">
                                                                                    <option value="">انتخاب مسئول خرید
                                                                                    </option>
                                                                    ...
                                                                    @if(is_null($contractAmountValue["buy_status"]))
                                                                        @if($contractAmountValue["status"] == 'ordered')
                                                                            <form method="POST"
