<x-layout>
    ...
    <div class="my-4">
        <form method="POST" action="{{ route('separate.damper.calculateRaft') }}"
            ...
            <div class="grid grid-cols-5 gap-4">
                <div>
                    <label class="block mb-2 text-sm font-bold" for="inputDebiHavaRaft">دبی هوای رفت (CFM)</label>
                    <input type="text" class="input-text bg-sky-100" id="inputDebiHavaRaft" name="debi_hava_raft"
                ...
                <div>
                    ...
                    <input type="text" class="input-text bg-sky-100" id="inputSoratExast" name="sorat_hava"
