<x-layout>
    ...
    <div class="my-4">
        <form method="POST" action="{{ route('separate.damper.calculateTaze') }}"
            ...
            <div class="grid grid-cols-5 gap-4">
                <div>
                    ...
                    <input type="text" class="input-text bg-sky-100" id="inputDebiHavaTaze" name="debi_hava_taze"
                ...
                <div>
                    ...
                    <input type="text" class="input-text bg-sky-100" id="inputSoratTaze" name="sorat_hava"
