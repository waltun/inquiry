<x-layout>
    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function calculate() {
                ...
                document.getElementById('damperName').value = `دمپر رفت با تعداد پره ${tedadPare} و طول پره ${toolePareResult.toFixed(2)} و دبی هوای رفت ${debiHavaRaft}`;
            }
        </script>
    </x-slot>
    ...
    <form method="POST" action="{{ route('calculateDamper.store',[$part->id,$product->id]) }}" class="mt-4">
        ...
        <input type="hidden" name="name" value="" id="damperName">
