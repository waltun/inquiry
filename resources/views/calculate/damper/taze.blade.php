    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function calculate() {
                ...
                let soratTaze = parseFloat(document.getElementById("inputSoratTaze").value);
                ...
                //Formula
                let toolePareResult = (((debiHavaTaze / soratTaze) / 10.7639) / tedadPare) * 1000;
                ...
                document.getElementById('damperName').value = `دمپر تازه با تعداد پره ${tedadPare} و طول پره ${toolePareResult.toFixed(2)} و دبی هوای تازه ${debiHavaTaze}`;
            }
        </script>
    </x-slot>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block mb-2 text-sm font-bold" for="inputSoratTaze">
                        سرعت هوا روی دمپر تازه
                    </label>
                    <input type="text" class="input-text" id="inputSoratTaze" onkeyup="calculate()"
                           value="800">
                </div>
                <div>
