    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function calculate() {
                ...
                let soratExast = parseFloat(document.getElementById("inputSoratExast").value);
                ...
                //Formula
                let toolePareResult = (((debiHavaExast / soratExast) / 10.7639) / tedadPare) * 1000;
                ...
                inputValues[6].value = keshoyiChapResult.toFixed(4);
                ...
                inputValues[7].value = keshoyiRastResult.toFixed(4);
                ...
                document.getElementById('damperName').value = `دمپر اگزاست با تعداد پره ${tedadPare} و طول پره ${toolePareResult.toFixed(2)} و دبی هوای اگزاست ${debiHavaExast}`;
            }
        </script>
    </x-slot>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block mb-2 text-sm font-bold" for="inputSoratExast">
                        سرعت هوا روی دمپر اگزاست
                    </label>
                    <input type="text" class="input-text" id="inputSoratExast" onkeyup="calculate()" value="800">
                </div>
                <div>
