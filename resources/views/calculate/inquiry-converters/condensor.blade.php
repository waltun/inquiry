<x-layout>
    ...
    <form method="POST" action="{{ route('inquiryPart.converter.calculateCondensor') }}">
        @csrf
        <div class="my-4">
    ...
    <div class="mt-4">
        @if(!is_null($values))
            <form method="POST" action="{{ route('inquiryPart.converter.storeCondensor',[$inquiry->id,$part->id]) }}"
