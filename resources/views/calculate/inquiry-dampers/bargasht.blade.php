<x-layout>
    ...
    <div class="my-4">
        <form method="POST" action="{{ route('inquiryPart.damper.calculateBargasht') }}"
            ...
            <div class="grid grid-cols-5 gap-4">
                <div>
                    ...
                    <input type="text" class="input-text" id="inputDebiHavaBargasht" name="debi_hava_bargasht"
                ...
                <div>
                    ...
                    <input type="text" class="input-text" id="inputSoratBargasht" name="sorat_hava"
    ...
    <!-- Content -->
    @if(!is_null($values))
        <form method="POST" action="{{ route('inquiryPart.damper.store',[$inquiry->id, $part->id]) }}" class="mt-4">
            @csrf
