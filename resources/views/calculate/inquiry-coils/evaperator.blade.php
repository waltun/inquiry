                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tedad_madar_coil" id="inputTedadMadar" class="input-text bg-yellow-300">
                            <option value="">انتخاب کنید</option>
                            <option value="1"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '1' ? 'selected' : '') }}>
                                1
                            </option>
                            <option value="2"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '2' ? 'selected' : '') }}>
                                2
                            </option>
                            <option value="3"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '3' ? 'selected' : '') }}>
                                3
                            </option>
                            <option value="4"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '4' ? 'selected' : '') }}>
                                4
                            </option>
                            <option value="6"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '6' ? 'selected' : '') }}>
                                6
                            </option>
                            <option value="8"
                                {{ is_null($inputs) ? '' : ($inputs['tedad_madar_coil'] == '8' ? 'selected' : '') }}>
                                8
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-span-4">
                        ...
                        <input type="text" class="input-text bg-yellow-300"
                               ...
                               value="{{ !is_null($inputs) ? $inputs['tedad_soorakh_pakhshkon'] : '' }}">
                    </div>
                </div>
            </div>
        </div>
