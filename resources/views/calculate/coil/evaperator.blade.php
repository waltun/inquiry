    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function calculate() {
                ...
                let tedadMadar = parseFloat(document.getElementById('inputTedadMadar').value);
                ...
                if (looleMessiId === '58') {
                    ...
                    if (collectorAhaniId) {
                        vaznBerenjMasrafiResult = (tedadMadarLoole) * 4.5;
                    } else {
                ...
                if (looleMessiId === '53') {
                    ...
                    if (collectorAhaniId) {
                        vaznBerenjMasrafiResult = (tedadMadarLoole) * 3;
                    } else {
                        vaznBerenjMasrafiResult = 0
                    }
                }
                ...
                if (looleMessiId === '56') {
                    ...
                    if (collectorAhaniId) {
                        vaznBerenjMasrafiResult = (tedadMadarLoole) * 4;
                    } else {
                        vaznBerenjMasrafiResult = 0
                    }
                }
                ...
                if (collectorAhaniId === '70') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 1.94 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 1.94 / 2;
                    }
                }
                if (collectorAhaniId === '71') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 2.48 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 2.48 / 2;
                    }
                }
                if (collectorAhaniId === '72') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 2.81 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 2.81 / 2;
                    }
                }
                if (collectorAhaniId === '73') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 4.32 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 4.32 / 2;
                    }
                }
                if (collectorAhaniId === '74') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 5.48 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 5.48 / 2;
                    }
                }
                if (collectorAhaniId === '75') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 7.56 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 7.56 / 2;
                    }
                }
                if (collectorAhaniId === '76') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 11.18 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorAhaniResult = ((ertefaFinResult + 250) / 1000) * 11.18 / 2;
                    }
                }
                ...
                if (collectorMessiId === '77') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.196 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '78') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.268 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.268 / 2;
                    }
                }
                if (collectorMessiId === '79') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.339 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.339 / 2;
                    }
                }
                if (collectorMessiId === '80') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.54 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.54 / 2;
                    }
                }
                if (collectorMessiId === '81') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 0.975 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '82') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 1.410 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 4.410 / 2;
                    }
                }
                if (collectorMessiId === '83') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 1.685 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '84') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 2.360 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 2.360 / 2;
                    }
                }
                if (collectorMessiId === '85') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 3.616 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '86') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 4.95 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '87') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 6.9 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                if (collectorMessiId === '88') {
                    if (tedadMadar === 1 || tedadMadar === 2 || tedadMadar === 3) {
                        collectorMessiResult = ((ertefaFinResult + 250) / 1000) * 7.89 * tedadMadar;
                    }
                    if (tedadMadar === 4 || tedadMadar === 6 || tedadMadar === 8) {
                ...
                price10 = inputTotalPrice[10].value * 2;
                ...
                if (tedadSoorakhPakhshKon === tedadSoorakhPakhshKon && tedadSoorakhPakhshKon > 0 && typeof tedadSoorakhPakhshKon !== 'undefined') {
                    valueSection[12].innerText = tedadSoorakhPakhshKon.toFixed(2);
                    inputValues[12].value = tedadSoorakhPakhshKon.toFixed(2);
                    price12 = inputTotalPrice[12].value * tedadSoorakhPakhshKon;
                ...
                if (roghaneTabkhirShavandeResult === roghaneTabkhirShavandeResult && roghaneTabkhirShavandeResult > 0 && typeof roghaneTabkhirShavandeResult !== 'undefined') {
                    valueSection[13].innerText = roghaneTabkhirShavandeResult.toFixed(2);
                    inputValues[13].value = roghaneTabkhirShavandeResult.toFixed(2);
                    price13 = inputTotalPrice[13].value * roghaneTabkhirShavandeResult;
                ...
                if (vaznVaraghMasrafiResult === vaznVaraghMasrafiResult && vaznVaraghMasrafiResult > 0 && typeof vaznVaraghMasrafiResult !== 'undefined') {
                    valueSection[14].innerText = vaznVaraghMasrafiResult.toFixed(2);
                    inputValues[14].value = vaznVaraghMasrafiResult.toFixed(2);
                    price14 = inputTotalPrice[14].value * vaznVaraghMasrafiResult;
                ...
                if (looleMessiResult === looleMessiResult && looleMessiResult > 0 && typeof looleMessiResult !== 'undefined') {
                    valueSection[15].innerText = looleMessiResult.toFixed(2);
                    inputValues[15].value = looleMessiResult.toFixed(2);
                    price15 = inputTotalPrice[15].value * looleMessiResult;
                ...
                if (vaznFinAlResult === vaznFinAlResult && vaznFinAlResult > 0 && typeof vaznFinAlResult !== 'undefined') {
                    valueSection[16].innerText = vaznFinAlResult.toFixed(2);
                    inputValues[16].value = vaznFinAlResult.toFixed(2);
                    price16 = inputTotalPrice[16].value * vaznFinAlResult;
                ...
                if (collectorMessiResult === collectorMessiResult && collectorMessiResult > 0 && typeof collectorMessiResult !== 'undefined') {
                    valueSection[17].innerText = collectorMessiResult.toFixed(2);
                    inputValues[17].value = collectorMessiResult.toFixed(2);
                    price17 = inputTotalPrice[17].value * collectorMessiResult;
                ...
                if (collectorAhaniResult === collectorAhaniResult && collectorAhaniResult > 0 && typeof collectorAhaniResult !== 'undefined') {
                    valueSection[18].innerText = collectorAhaniResult.toFixed(2);
                    inputValues[18].value = collectorAhaniResult.toFixed(2);
                ...
                if (tedadUResult === tedadUResult && tedadUResult > 0 && typeof tedadUResult !== 'undefined') {
                    valueSection[19].innerText = tedadUResult.toFixed(2);
                    inputValues[19].value = tedadUResult.toFixed(2);
                    price19 = inputTotalPrice[19].value * tedadUResult;
                ...
                finalPrice = price0 + price1 + price2 + price3 + price4 + price5 + price6 + price7 + price8 + price9
                    + price10 + price11 + price12 + price13 + price14 + price15 + price16 + price17 + price18 + price19 + price20;
            ...
            function sendDataLooleMessi(id) {
                let looleMessiNameSection = document.getElementById('nameSection15');
                let looleMessiPriceSection = document.getElementById('priceSection15');
                let looleMessiUnitSection = document.getElementById('unitSection15');

                let uMessiNameSection = document.getElementById('nameSection19');
                let uMessiPriceSection = document.getElementById('priceSection19');
            ...
            function sendDataUMessi(id) {
                let uMessiNameSection = document.getElementById('nameSection19');
                let uMessiPriceSection = document.getElementById('priceSection19');
                let uMessiUnitSection = document.getElementById('unitSection19');
            ...
            function sendDataFinCoil(id) {
                let finCoilNameSection = document.getElementById('nameSection16');
                let finCoilPriceSection = document.getElementById('priceSection16');
                let finCoilUnitSection = document.getElementById('unitSection16');
            ...
            function sendDataVaraghGalvanize(id) {
                let varaghGalvanizeNameSection = document.getElementById('nameSection14');
                let varaghGalvanizePriceSection = document.getElementById('priceSection14');
                let varaghGalvanizeUnitSection = document.getElementById('unitSection14');
            ...
            function sendDataElectrodNoghre(id) {
                let electrodNoghreNameSection = document.getElementById('nameSection20');
                let electrodNoghrePriceSection = document.getElementById('priceSection20');
                let electrodNoghreUnitSection = document.getElementById('unitSection20');
