<x-layout>
    ...
    <div class="flex items-center justify-between mt-8">
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            <a href="{{ route('modells.create',$group->id) }}" class="page-warning-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>
                </svg>
                <span class="mr-2">افزودن زیردسته جدید</span>
            </a>
        </div>
    </div>

    <div class="mt-6 space-y-4">
        @foreach($group->modells()->where('parent_id',0)->get() as $model)
            <div class="dashboard-cards group">
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div class="space-x-4 space-x-reverse flex items-center">
                        <a href="{{ route('modells.children',$model->id) }}"
                        ...
                        <div x-data="{open:false}" class="flex relative">
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                ...
                                <a href="{{ route('modells.replicate',$model->id) }}"
                                ...
                                <a href="{{ route('modells.edit',$model->id) }}"
                                ...
                                <form action="{{ route('modells.destroy',$model->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
