<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('groups.update',$group->id) }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div>
                <label for="inputName" class="form-label">نام گروه</label>
                <input type="text" id="inputName" name="name" class="input-text" value="{{ $group->name }}">
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div>
                <label for="inputCode" class="form-label">کد گروه</label>
                <input type="text" id="inputCode" name="code" class="input-text" value="{{ $group->code }}">
            </div>
