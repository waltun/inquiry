<x-layout>
    ...
    <!-- Edit Store form -->
    <form method="POST" action="{{ route('coding-exits.update', $coding_exit->id) }}" class="mt-6 space-y-4">
        @csrf
        @method('PATCH')

        @if(is_null($coding_exit->coding_id) || request()->has('coding'))
            <input type="hidden" name="coding_id" value="{{ $selectedCoding->id ?? '' }}">
        @else
            @php
                $currentCoding = \App\Models\System\Coding::find($coding_exit->coding_id);
            @endphp
        ...
        <div class="card">
            <div class="mb-4 flex justify-end items-center">
                <div class="flex items-center">
                    ...
                    <input type="text" name="return_date" id="inputDate" class="input-text" value="{{ $date }}"
                           placeholder="تاریخ عودت">
                </div>
            </div>
            <table class="w-full">
                <thead>
                ...
                <tr class="text-xs border border-gray-400 text-center">
                                                                ...
                                                                <tr class="table-tb-tr group">
                                                                    ...
                                                                    <td class="table-tr-td border-t-0 border-r-0">
                                                                        <div
                                                                            ...
                                                                            <a href="{{ route('coding-exits.edit',$coding_exit->id) }}?coding={{ $coding2->id }}"
                    ...
                    <td class="p-1 border-r border-gray-400">
                        @if(is_null($coding_exit->coding_id) || request()->has('coding'))
                            <input type="text" name="name" id="inputName"
                                   value="{{ $selectedCoding->name ?? $coding_exit->name }}"
                    ...
                    <td class="p-1 border-r border-gray-400">
                        <input type="text" name="quantity" id="inputQuantity" class="input-text w-20 text-center"
                               placeholder="تعداد" value="{{ $coding_exit->quantity }}">
                    </td>
                    <td class="p-1 border-r border-gray-400">
                        @if(is_null($coding_exit->coding_id) || request()->has('coding'))
                ...
                <tr class="text-xs text-center">
                    ...
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputGetterName" class="form-label whitespace-nowrap mb-0 ml-2">
                                تحویل گیرنده
                            </label>
                            <input type="text" name="getter_name" id="inputGetterName" class="input-text"
                                   placeholder="تحویل گیرنده" value="{{ $coding_exit->getter_name }}">
                        </div>
                    </td>
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputCarNumber" class="form-label whitespace-nowrap mb-0 ml-2">
                                شماره خودرو
                            </label>
                            <input type="text" name="car_number" id="inputCarNumber" class="input-text" placeholder="شماره خودرو"
                                   value="{{ $coding_exit->car_number }}">
                        </div>
                    </td>
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputPhone" class="form-label whitespace-nowrap mb-0 ml-2">شماره موبایل</label>
                            <input type="text" name="phone" id="inputPhone" class="input-text" placeholder="شماره موبایل"
                                   value="{{ $coding_exit->phone }}">
                        </div>
                    </td>
                </tr>
                <tr class="text-xs text-center">
                    <td></td>
                    <td class="p-1 border border-gray-400" colspan="3">
                        <div class="flex items-center">
                            ...
                            <input type="text" name="description" id="inputDescription" class="input-text"
                                   placeholder="توضیحات" value="{{ $coding_exit->description }}">
                        </div>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <a href="{{ route('coding-exits.index') }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
