<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('employees.update', $employee->id) }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputInsurance" name="insurance" class="input-text"
                       placeholder="مثال : 11111111" value="{{ old('insurance', $employee->insurance) }}">
            </div>

            <div class="mb-4">
                <label for="inputPhone" class="form-label">شماره تماس</label>
                <input type="text" id="inputPhone" name="phone" class="input-text"
                       placeholder="مثال : 09022228553" value="{{ old('phone', $employee->phone) }}">
            </div>
