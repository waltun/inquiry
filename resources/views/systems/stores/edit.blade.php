<x-layout>
    ...
    <!-- Edit Store form -->
    <form method="POST" action="{{ route('stores.update',$store->id) }}" class="mt-6 space-y-4">
        @csrf
        @method('PATCH')

        @if(is_null($store->coding_id) || request()->has('coding'))
            <input type="hidden" name="coding_id" value="{{ $selectedCoding->id ?? '' }}">
        @else
            @php
                $currentCoding = \App\Models\System\Coding::find($store->coding_id);
            @endphp
            ...
            <table class="w-full">
                ...
                <tr class="text-xs border border-gray-400 text-center">
                                                                ...
                                                                <tr class="table-tb-tr group">
                                                                    ...
                                                                    <td class="table-tr-td border-t-0 border-r-0">
                                                                        <div
                                                                            ...
                                                                            <a href="{{ route('stores.edit',$store->id) }}?coding={{ $coding2->id }}"
                    ...
                    <td class="p-1 border-r border-gray-400">
                        @if(is_null($store->coding_id) || request()->has('coding'))
                            <input type="text" name="name" id="inputName"
                                   value="{{ $selectedCoding->name ?? $store->name }}"
                    ...
                    <td class="p-1 border-r border-gray-400">
                        <input type="text" name="quantity" id="inputQuantity" class="input-text w-20 text-center"
                               placeholder="تعداد" value="{{ $store->quantity }}">
                    </td>
                    <td class="p-1 border-r border-gray-400">
                        @if(is_null($store->coding_id) || request()->has('coding'))
                ...
                <tr class="text-xs text-center">
                    ...
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputDelivery" class="form-label whitespace-nowrap mb-0 ml-2">تحویل
                                دهنده</label>
                            <input type="text" name="delivery" id="inputDelivery" class="input-text"
                                   placeholder="تحویل دهنده" value="{{ $store->delivery }}">
                        </div>
                    </td>
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputSeller" class="form-label whitespace-nowrap mb-0 ml-2">فروشنده</label>
                            <input type="text" name="seller" id="inputSeller" class="input-text" placeholder="فروشنده"
                                   value="{{ $store->seller }}">
                        </div>
                    </td>
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputCode" class="form-label whitespace-nowrap mb-0 ml-2">شماره فاکتور</label>
                            <input type="text" name="code" id="inputCode" class="input-text" placeholder="شماره فاکتور"
                                   value="{{ $store->code }}">
                        </div>
                    </td>
                </tr>
                <tr class="text-xs text-center">
                    ...
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            <label for="inputStore" class="form-label whitespace-nowrap mb-0 ml-2">انتخاب انبار</label>
                            <select name="store" id="inputStore"
                                    class="input-text py-1.5">
                                <option value="10" {{ $store->store == '10' ? 'selected' : '' }}>
                                    انبار مواد اولیه | 10
                                </option>
                                <option value="12" {{ $store->store == '12' ? 'selected' : '' }}>
                                    انبار ملزومات | 12
                                </option>
                                <option value="14" {{ $store->store == '14' ? 'selected' : '' }}>
                                    انبار محصولات | 14
                                </option>
                            </select>
                        </div>
                    ...
                    <td class="p-1 border border-gray-400">
                        <div class="flex items-center">
                            ...
                            <input type="text" name="description" id="inputDescription" class="input-text"
                                   placeholder="توضیحات" value="{{ $store->description }}">
                        </div>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <a href="{{ route('stores.index') }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
