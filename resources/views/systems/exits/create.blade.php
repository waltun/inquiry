<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('exits.store') }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputExiter" name="exiter" class="input-text" placeholder="نام خارج کننده کالا" value="{{ old('exiter') }}">
            </div>
            <div class="mb-4">
                <label for="inputCarNumber" class="form-label">شماره خودرو</label>
                <input type="text" id="inputCarNumber" name="car_number" class="input-text" placeholder="شماره خودرو خارج کننده" value="{{ old('car_number') }}">
            </div>
            <div class="mb-4">
                <label for="inputPhone" class="form-label">شماره تلفن و آدرس</label>
                <input type="text" id="inputPhone" name="phone" class="input-text" placeholder="شماره تلفن و آدرس" value="{{ old('phone') }}">
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="hidden" id="missionSection">
                <div class="mt-4">
                    <label for="inputMissionLocation" class="form-label">محل ماموریت</label>
                    <input type="text" id="inputMissionLocation" name="mission_location" class="input-text" placeholder="محل ماموریت را وارد کنید" value="{{ old('mission_location') }}">
                </div>
                <div class="mt-4">
                    <label for="inputMissionReason" class="form-label">علت ماموریت</label>
                    <input type="text" id="inputMissionReason" name="mission_reason" class="input-text" placeholder="محل ماموریت را وارد کنید" value="{{ old('mission_reason') }}">
                </div>
                <div class="mt-4">
