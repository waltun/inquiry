<x-layout>
    ...
    <!-- Create User form -->
    <form action="{{ route('serials.store') }}" method="post" class="mt-11">
        @csrf
            ...
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-10">
                    <input type="text" name="year" id="inputYear" class="input-text"
                           placeholder="سال تولید (کامل) : 1402" value="{{ old('year') ?? jdate()->getYear() }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="serial" id="inputSerial" class="input-text"
                           placeholder="شماره سریال (فقط عدد)" value="{{ old('serial') ?? $serialNumber }}">
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="number" id="inputNumber" class="input-text"
                           placeholder="شماره قرارداد (فقط عدد)" value="{{ old('number') }}">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-10">
                    <select name="type" id="inputType" class="input-text">
                        ...
                        <option value="official" {{ old('type') == 'official' ? 'selected' : '' }}>
                            رسمی
                        </option>
                        <option value="operational" {{ old('type') == 'operational' ? 'selected' : '' }}>
                            عملکردی
                        </option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-10">
                    <input type="text" name="send_date" id="inputSendDate" class="input-text" value="{{ $today }}">
                </div>
            </div>
        </div>
