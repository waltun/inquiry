<x-layout>
    ...
    <!-- Create User form -->
    <form action="{{ route('phonebook.update',$phonebook->id) }}" method="post" class="mt-6 grid grid-cols-2 gap-4">
        @csrf
        @method('PATCH')
            ...
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-10">
                    <input type="text" name="title" id="inputTitle" class="input-text" placeholder="شرح"
                           value="{{ old('title') ?? $phonebook->title }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="activity" id="inputActivity" class="input-text" placeholder="نوع فعالیت"
                           value="{{ old('activity') ?? $phonebook->activity }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="phone1" id="inputPhone1" class="input-text" placeholder="تلفن اول"
                           value="{{ old('phone1') ?? $phonebook->phone1 }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="phone2" id="inputPhone2" class="input-text" placeholder="تلفن دوم"
                           value="{{ old('phone2') ?? $phonebook->phone2 }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="mobile1" id="inputMobile1" class="input-text" placeholder="تلفن همراه اول"
                           value="{{ old('mobile1') ?? $phonebook->mobile1 }}">
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="mobile2" id="inputMobile2" class="input-text" placeholder="تلفن همراه دوم"
                           value="{{ old('mobile2') ?? $phonebook->mobile2 }}">
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-10">
                    <textarea name="description" id="inputDescription"
                              class="input-text h-32 resize-none">{{ old('description') ?? $phonebook->description }}</textarea>
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <textarea name="address" id="inputAddress"
                              class="input-text h-32 resize-none">{{ old('address') ?? $phonebook->address }}</textarea>
                </div>
            </div>
            <div class="mb-4 grid grid-cols-12 gap-4 items-center">
                <div class="col-span-2">
                ...
                <div class="col-span-10">
                    <input type="text" name="postal" id="inputPostal" class="input-text" placeholder="کد پستی"
                           value="{{ old('postal') ?? $phonebook->postal }}">
                </div>
            </div>
        </div>
        ...
        <div class="col-span-2 card bg-sky-100">
            <div class="flex items-center justify-center space-x-8 space-x-reverse">
                <div class="flex items-center">
                    <input type="radio" id="inputCategory1" value="مشتریان"
                           name="category" {{ $phonebook->category == 'مشتریان' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory2" value="تامین کنندگان"
                           name="category" {{ $phonebook->category == 'تامین کنندگان' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory3" value="مهندسین مشاور"
                           name="category" {{ $phonebook->category == 'مهندسین مشاور' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory4" value="تبلیغات"
                           name="category" {{ $phonebook->category == 'تبلیغات' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory5" value="همکاران"
                           name="category" {{ $phonebook->category == 'همکاران' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory6" value="بانک"
                           name="category" {{ $phonebook->category == 'بانک' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory7" value="بیمه"
                           name="category" {{ $phonebook->category == 'بیمه' ? 'checked' : '' }}>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory7" value="ادارات دولتی"
                           name="category" {{ $phonebook->category == 'ادارات دولتی' ? 'checked' : '' }}>
                    <label for="inputCategory7" class="form-label mb-0 mr-1">
                        ادارات دولتی
                    </label>
                </div>
                ...
                <div class="flex items-center">
                    <input type="radio" id="inputCategory8" value="سایر"
                           name="category" {{ $phonebook->category == 'سایر' ? 'checked' : '' }}>
