                    ...
                    <tr class="table-tb-tr group">
                        ...
                        <td class="table-tr-td border-r-0 border-r-0 whitespace-nowrap">
                            <div class="flex items-center justify-center space-x-4 space-x-reverse relative"
                                ...
                                @endcan
                                <form method="POST" action="{{ route('inquiries.addToInvoice',$inquiry->id) }}">
                                    @csrf
                                    <button class="table-dropdown-edit"
                                            onclick="return confirm('پیش فاکتور برای این استعلام صادر شود ؟')">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                                            <path stroke-linecap="round" stroke-linejoin="round"
