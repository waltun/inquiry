    ...
    <div class="flex items-center justify-between mt-8">
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            <a href="{{ route('roles.create') }}" class="page-success-btn">
                ...
                <span class="mr-2">ایجاد نقش جدید</span>
            </a>
            <a href="{{ route('permissions.index') }}" class="page-warning-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                          d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/>
                </svg>
                <span class="mr-2">دسترسی ها</span>
            </a>
        </div>
    </div>
                    ...
                    <tr class="table-tb-tr group {{ $loop->even ? 'bg-sky-100' : '' }}">
                        ...
                        <td class="table-tr-td border-t-0 border-r-0">
                            <div class="flex items-center space-x-4 space-x-reverse">
                                ...
                                <a href="{{ route('roles.edit',$role->id) }}" class="table-dropdown-edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                                        <path stroke-linecap="round" stroke-linejoin="round"
