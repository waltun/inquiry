<x-layout>
    ...
    <div class="mt-4 flex justify-between items-center space-x-4 space-x-reverse">
        ...
        <div>
            <a href="{{ route('roles.create') }}" class="form-submit-btn text-xs">ایجاد نقش جدید</a>
        </div>
    </div>
            ...
            <table class="min-w-full">
                ...
                @foreach($roles as $role)
                    <tr>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <p class="text-sm text-black text-center">{{ $role->name }}</p>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap">
                        ...
                        <td class="px-4 py-3 space-x-3 space-x-reverse whitespace-nowrap">
                            ...
                            <a href="{{ route('roles.edit',$role->id) }}" class="form-edit-btn text-xs">
                                ویرایش
                            </a>
                        </td>
                    </tr>
