<x-layout>
    ...
    <div class="flex items-center space-x-2 space-x-reverse">
        ...
        <a href="{{ route('letter-terms.index') }}" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="breadcrumb-svg">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('letter-terms.store') }}" class="mt-4">
        @csrf
        ...
        <div class="card">
            ...
            <div class="mt-4">
                ...
                <input type="text" class="input-text" name="name" id="inputName"
                       placeholder="مثال : معرفی نامه" value="{{ old('name') }}">
            </div>
