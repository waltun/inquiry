<x-layout>
        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    ویرایش نامه روتین {{ $letter_term->name }}
                </p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('letter-terms.index',$letter_term->id) }}" class="mt-4">
        ...
        <div class="card">
            ...
            <div class="mt-4">
                ...
                <input type="text" class="input-text" name="name" id="inputName"
                       placeholder="مثال : معرفی نامه" value="{{ $letter_term->name }}">
            </div>

            <div class="mt-4">
                <label for="inputDescription" class="form-label">توضیحات و شرایط فروش</label>
                <textarea name="description" id="inputDescription">{{ $letter_term->description }}</textarea>
            </div>
        ...
        <div class="mt-4 flex space-x-4 space-x-reverse items-center">
            ...
            <a href="{{ route('letter-terms.index') }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
