<x-layout>
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="mr-2 text-xs md:text-sm font-medium text-gray-400">
                        ایجاد تنظیمات نمایش رنگ برای قیمت
                    </span>
                </div>
            </li>
        </ol>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('settings.price-color.store') }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        ...
        <div class="col-span-2 bg-white shadow-sm p-4 rounded-md border border-gray-200 mb-4 md:mb-0">
            ...
            <div class="mt-4">
                ...
                <select name="price_color_type" id="inputPriceColorType" class="input-text w-1/3">
            ...
            <div class="mt-4">
                ...
                <input type="text" class="input-text w-1/3" id="inputPriceColorMidTime" name="price_color_mid_time"
            ...
            <div class="mt-4">
                ...
                <input type="text" class="input-text w-1/3" id="inputPriceColorLastTime" name="price_color_last_time"
                       placeholder="مثلا : 2 یا 24 یا 1">
            </div>
