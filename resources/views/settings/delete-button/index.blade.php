<x-layout>
    ...
    @if($settings->isEmpty())
        <div class="my-4 flex justify-end">
            <a href="{{ route('settings.delete-button.create') }}" class="form-submit-btn text-xs">
                ایجاد تنظیمات جدید
            </a>
        </div>
    @endif
        ...
        <div class="bg-white shadow overflow-x-auto rounded-lg hidden md:block">
            <table class="min-w-full">
                ...
                <tr class="bg-sky-200">
                    ...
                    <th scope="col" class="px-4 py-3 text-sm font-bold text-gray-800 text-center">
                        بخش کالاهای نیم ساخته
                    </th>
                    <th scope="col" class="px-4 py-3 text-sm font-bold text-gray-800 text-center">
                        بخش کویل و دمپر و مبدل و تابلو
                    </th>
                    <th scope="col" class="px-4 py-3 text-sm font-bold text-gray-800 text-center">
                        بخش کاربران
                    </th>
                ...
                @foreach($settings as $setting)
                    <tr>
                        ...
                        <td class="px-4 py-3 space-x-3 space-x-reverse whitespace-nowrap">
                            <a href="{{ route('settings.delete-button.edit',$setting->id) }}"
                               class="form-edit-btn text-xs">
                                ویرایش
                            </a>
                            <form action="{{ route('settings.delete-button.destroy',$setting->id) }}" method="POST"
                                  class="inline">
                                @csrf
                                @method('DELETE')
