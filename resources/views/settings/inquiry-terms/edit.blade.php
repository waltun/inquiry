<x-layout>
    ...
    <div class="flex items-center space-x-2 space-x-reverse">
        ...
        <a href="{{ route('settings.inquiryTerms.index') }}" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="breadcrumb-svg">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mr-2">
                <p class="breadcrumb-p">
                    شرایط فروش استعلام‌ها و پیش فاکتور ها
                </p>
            </div>
        </a>
        <div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('settings.inquiryTerms.update',$inquiryTerm->id) }}" class="mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mt-4">
                ...
                <input type="text" class="input-text" name="name" id="inputName"
                       placeholder="مثال : شرایط فروش فن کویل ها" value="{{ $inquiryTerm->name }}">
            </div>

            <div class="mt-4">
                <label for="inputDescription" class="form-label">توضیحات و شرایط فروش</label>
                <textarea name="description" id="inputDescription">{{ $inquiryTerm->description }}</textarea>
            </div>
        ...
        <div class="mt-4 flex space-x-4 space-x-reverse items-center">
            ...
            <a href="{{ route('settings.inquiryTerms.index') }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
