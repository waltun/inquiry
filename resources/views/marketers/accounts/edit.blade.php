<x-layout>
    ...
    <div class="flex items-center space-x-2 space-x-reverse whitespace-nowrap">
        ...
        <a href="{{ route('marketers.accounts.index', $marketerAccount->marketer->id) }}" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="breadcrumb-svg">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mr-2">
                <p class="breadcrumb-p">
                    حساب های {{ $marketerAccount->marketer->name }}
                </p>
            </div>
        </a>
        <div>
        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    ویرایش حساب {{ $marketerAccount->bank_name }}
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('marketers.accounts.update', $marketerAccount->id) }}" class="mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputBankName" name="bank_name" class="input-text"
                       value="{{ old('bank_name', $marketerAccount->bank_name) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputAccountNumber" name="account_number" class="input-text"
                       value="{{ old('account_number', $marketerAccount->account_number) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputCardNumber" name="card_number" class="input-text"
                       value="{{ old('card_number', $marketerAccount->card_number) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputShabaNumber" name="shaba_number" class="input-text"
                       value="{{ old('shaba_number', $marketerAccount->shaba_number) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputAccountName" name="account_name" class="input-text"
                       value="{{ old('account_name', $marketerAccount->account_name) }}"
        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <a href="{{ route('marketers.accounts.index', $marketerAccount->marketer->id) }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
