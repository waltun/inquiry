        ...
        <div class="flex items-center">
            ...
            <div class="mr-2">
                <p class="breadcrumb-p-active">
                    ویرایش مشتری استعلام {{ $client->name }}
                </p>
            </div>
        </div>
    </div>
