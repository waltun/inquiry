<x-clients.layout>
    <div>
        ...
        <div class="mb-4 flex space-x-4 space-x-reverse">
            <a href="{{ route('clients.invoices.print', [$user->id, $invoice->id]) }}" class="page-info-btn"
               target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('clients.invoices.printDatasheet', [$user->id, $invoice->id]) }}" class="page-info-btn"
               target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round"
