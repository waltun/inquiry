<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('todos.store') }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        ...
        <div class="card">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" id="inputDescription" class="input-text resize-none h-32">{{ old('description') }}</textarea>
            </div>
        </div>
