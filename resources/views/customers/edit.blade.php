<x-layout>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('customers.update', $customer->id) }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputAgentPhone" name="agent_phone" class="input-text"
                       placeholder="مثال : 09123456789" value="{{ old('agent_phone', $customer->agent_phone) }}">
            </div>
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputManagerName" name="manager_name" class="input-text"
                       value="{{ old('manager_name', $customer->manager_name) }}" placeholder="مثال : علی">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputManagerPhone" name="manager_phone" class="input-text"
                       value="{{ old('manager_phone', $customer->manager_phone) }}" placeholder="مثال : 09123456789">
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputTechnicalAgentName" name="technical_agent_name" class="input-text"
                       value="{{ old('technical_agent_name', $customer->technical_agent_name) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputTechnicalAgentPhone" name="technical_agent_phone" class="input-text"
                       value="{{ old('technical_agent_phone', $customer->technical_agent_phone) }}"
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="inputDeliveryAddress" name="delivery_address" class="input-text"
                       value="{{ old('delivery_address', $customer->delivery_address) }}" placeholder="مثال : تهران">
            </div>
        </div>
