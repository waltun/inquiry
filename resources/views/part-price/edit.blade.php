<x-layout>
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="mr-2 text-xs md:text-sm font-medium text-gray-400">
                        قیمت گذاری برای قطعه {{ $part->name }}
                    </span>
                </div>
            </li>
        </ol>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('parts.price.update',$part->id) }}" class="md:grid grid-cols-2 gap-4 mt-4">
        @csrf
        @method('PATCH')
        ...
        <div class="col-span-2 space-x-2 space-x-reverse">
            ...
            <a href="{{ route('parts.price.index') }}" class="form-cancel-btn">
                انصراف
            </a>
        </div>
    </form>
