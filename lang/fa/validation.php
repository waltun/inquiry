...
return [
    ...
    */
    'attributes' => [
        ...
        'tedad_radif_coil' => 'تعداد ردیف کویل',
        'fin_dar_inch' => 'فین در اینچ',
        'kham' => 'خم کویل',
        'tedad_madar_coil' => 'تعداد مدار کویل',
        'noe_coil' => 'نوع کویل',
        'toole_coil' => 'طول کویل',
        'tedad_loole_dar_radif' => 'تعداد لوله در ردیف',
        'tedad_mogheyiat_loole' => 'تعداد موقعیت یک لوله در ردیف',
        'tedad_madar_loole' => 'تعداد مدار لوله',
        'loole_messi_sucshen' => 'لوله مسی خط ساکشن',
        'loole_messi_maye' => 'لوله مسی خط مایع',
        'size_loole_pooste' => 'سایز لوله پوسته',
        'picho_mohre' => 'پیچ و مهره',
        'ayegh' => 'عایق',
        'sensor' => 'کانکشن سنسور های ورودی و خروجی',
        'cap' => 'کپ',
        'navdani' => 'ناودانی',
        'boshen1' => 'بوشن فشار قوی ایرونت',
        'boshen2' => 'بوشن فشار قوی آنتی فریز',
        'flanch' => 'فلنچ ورودی و خروجی',
        'size_loole_ab' => 'سایز لوله ورودی و خروجی آب',
        'sardande' => 'سر دنده ورودی و خروجی',
        'tube' => 'توپ شیت',
        'ring' => 'رینگ رو بند',
